...
\par{\normalsize\centering{{Theoretical evolutionary ecologist with diverse quantitative skills including comparative analysis, analytical energetics equations and individual based modeling approaches.}}\bigskip\par}
...
\par{\fontsize{10.5}{10} Ten week program under the supervision of Dr. Christen Griffen investigating the evolutionary divergence of entomopathogenic nematodes.\bigskip}
...
\textbf{In review}\\
\setlength{\parindent}{0mm}Kane, A., \textbf{Healy, K.,} Ruxton, G.D., and Jackson, A.L. \textbf{Healy, K}. 2015. Body size drives importance of scavenging in theropods. \textit{In review AmNat}.
\smallskip
\par{\fontsize{10.5}{10} Corresponding and Co-first author. Showed that theropod dinosaurs of intermediate body size are more efficient scavengers than individuals of extreme body sizes by using individual based modeling. I co-conceived the idea and carried out the data collection, analysis and writing of the paper.}

\textbf{In prep}\\
\setlength{\parindent}{0mm}\textbf{Healy, K.,} Kelly, S.B.A., Guillerme, T., Inger, R., Bearhop, S., Jackson, A.L. Predicting trophic enrichment factors using Bayesian inference and phylogenetic, ecological and physiological data. FestR. Fractionation estimation using R.
\smallskip

\setlength{\parindent}{0mm}\textbf{Healy, K.,} Carbone, C., and Jackson, A.L. Venom evolution in snakes is driven by body size, habitat dimensionality and a diet of eggs.
...
\begin{tabular}{ll}
%-------------------------------
\textbf{2015:} & TEDxUCD invited speaker (https://www.youtube.com/watch?v=-CHtfWEKifY).\\ 
& \textsl{Talk}: "Listening to evolutionary oddities".\\
%-------------------------------
...
%-------------------------------
\textbf{2015:} & British Ecological Society Annual meeting Edinburgh.\\ 
& \textsl{Talk}: "Venom evolution in snakes; body size, habitat dimensionality\\
&and a diet of eggs".\\
%-------------------------------
...
&Senior Sophisters.\\
&My teaching involves a mix of traditional style lecturing combined\\
